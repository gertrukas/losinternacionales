<header class="container">
    <nav class="">
        <div class="flex flex-wrap items-center justify-between">
            ...
            <a href="/" class="flex justify-center items-center p-4">
                <img src='{{ asset('images/los-internacionales.webp') }}' width="300" height="auto">
            </a>
    ...
    <div>
        <a href="https://wa.me/525553362200?text='hola%20Los%20Internacionales" target="_blank"
